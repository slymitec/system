...
public class AccountTokenObjectTaskInitializer extends ATaskInitializer {
    public AccountTokenObjectTaskInitializer() {
        this.cacheableObjectFunction = (handle) -> this.coreManager.getManager(UserManager.class).getFactory().rebuildAccountToken(handle);
