...
@RestController
@Transactional
public class TProcessController extends ATController {
    @RequestMapping(value = {"/TProcessSession.action"}, method = {RequestMethod.GET})
    @Transactional
    ...
    @RequestMapping(value = {"/TProcessShut.action"}, method = {RequestMethod.GET})
    @Transactional
    ...
    @RequestMapping(value = {"/TProcessDisplay.action"}, method = {RequestMethod.GET})
    @Transactional
    ...
    @RequestMapping(value = {"/TProcessStatus.action"}, method = {RequestMethod.GET})
    @Transactional
    ...
    @RequestMapping(value = {"/TProcessSignal.action"}, method = {RequestMethod.GET})
    @Transactional
