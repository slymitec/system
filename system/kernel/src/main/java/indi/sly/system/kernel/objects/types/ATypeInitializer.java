...
public abstract class ATypeInitializer extends ACoreObject {
    ...
    protected abstract Class<? extends AInfoContentObject> getContentProcedureType(InfoEntity info, StatusOpenDefinition statusOpen);
    ...
    public final AInfoContentObject getContentProcedure(InfoEntity info, Provider<byte[]> funcRead, Consumer<byte[]> funcWrite, StatusOpenDefinition statusOpen) {
        AInfoContentObject content = this.factoryManager.create(this.getContentProcedureType(info, statusOpen));
