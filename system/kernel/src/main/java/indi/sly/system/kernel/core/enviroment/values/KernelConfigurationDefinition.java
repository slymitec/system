...
public class KernelConfigurationDefinition extends ADefinition {
    ...
    public final UUID SERVICE_TYPE_INSTANCE_SERVICE_ID
            = UUIDUtil.getFormLongs(-623865349106545073L, -6997297376516953324L);
    public final UUID SERVICE_TABLE_ID = UUIDUtil.getFormLongs(-3687831299068770016L, -5951841443637097351L);
    public final UUID SERVICE_TABLE_LOCK_ID = UUIDUtil.getFormLongs(-1889690034818560723L, -6740428121948687006L);
