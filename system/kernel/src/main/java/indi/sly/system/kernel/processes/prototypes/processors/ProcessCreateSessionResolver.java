...
public class ProcessCreateSessionResolver extends AResolver implements IProcessCreateResolver {
    ...
    public ProcessCreateSessionResolver() {
        this.create = (process, parentProcess, processCreator) -> {
            ...
            if (processCreator.inheritSession() && !ValueUtil.isAnyNullOrEmpty(parentProcessSession.getId())) {
